...
public:
     ...
     **/
    void line ( cv::Mat &view, const Point2D &p0, const Point2D &p1, const cv::Scalar &color, int thickness=1, int lineType = cv::LINE_AA ) const;
    /**
     ...
     * @param lineType line type --> @see opencv
     **/
    void circle ( cv::Mat &view, const Point2D &p, int radius, const cv::Scalar &color, int thickness=1, int lineType = cv::LINE_AA ) const;
