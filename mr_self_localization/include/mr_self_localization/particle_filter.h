 ...
 */
    ...
    public:
         ...
         **/
        void loadMap(int width_pixel, int height_pixel, double min_x, double max_x, double min_y, double max_y,
    ...
    private:
         ...
         **/
        SamplePtr &uniform(SamplePtr &sample, std::uniform_real_distribution<double> distribution_x,
