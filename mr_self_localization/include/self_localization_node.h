 ...
 **/
class SelfLocalizationNode : public moro::SelfLocalization {
public:
...
private:
    ...
    geometry_msgs::PoseArray pose_array_; /// particles to publish
    ...
    dynamic_reconfigure::Server<mr_self_localization::SelfLocalizationConfig> reconfigureServerSelfLocalization_; /// parameter server stuff general use
    dynamic_reconfigure::Server<mr_self_localization::SelfLocalizationConfig>::CallbackType reconfigureFncSelfLocalization_; /// parameter server stuff general use
    void callbackConfigSelfLocalization ( mr_self_localization::SelfLocalizationConfig &config, uint32_t level ); /// callback function on incoming parameter changes for general use
    
    std::shared_ptr<dynamic_reconfigure::Server<mr_self_localization::ParticleFilterConfig> > reconfigureServerParticleFilter_; /// parameter server stuff for the mcl
    dynamic_reconfigure::Server<mr_self_localization::ParticleFilterConfig>::CallbackType reconfigureFncParticleFilter_; /// parameter server stuff for the mcl
    void callbackConfigParticleFilter ( mr_self_localization::ParticleFilterConfig &config, uint32_t level ); /// callback function on incoming parameter changes for the mcl
