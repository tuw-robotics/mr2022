...
void WorldScopedMaps::init () {
    ...
    mx_ =   (max_x_ + min_x_)/2; // visual image space x
    my_ =   (max_y_ + min_y_)/2; // visual image space y
    ...
    Mw2m_ = Tm * R * Sp * Sc * Tw;
    // Mw2m_ = cv::Matx<double, 3, 3 > ( -3.061616997868383e-15, -50, 250, -50, 3.061616997868383e-15, 250, 0, 0, 1 ); 
#endif
